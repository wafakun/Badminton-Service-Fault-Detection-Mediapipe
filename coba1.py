...
cascade_path = "/Badminton Service Fault Detection/cascade3.xml"
...
def main():
    ...
    parser.add_argument("-mtc", "--min-tracking-confidence", type=float, default=0.6,
            ...
            if statusTombol == True :    
                ...
                if roi.size >0 and hitung > 50:
                    # Convert the frame to grayscale for cascade detection
                        ...
                        line_height = int(1.1405*t_posisi2-10)
                        cv2.line(image, (0, line_height), (2000, line_height), (255, 255, 255), 3)   
                        if line_height >= t_posisi1:
                            if saveData:
                                while I <= 1:

...
"}")
    ...
    def btn1(self):
        os.system('python -u "C:/multi-pose-landmark-mediapipe-main/coba1.py"')

    def btn2(self):
        os.system('python -u "C:/multi-pose-landmark-mediapipe-main/coba2.py"')  

    def openvideo(self):
        os.system('python -u "C:/multi-pose-landmark-mediapipe-main/GUI TA/openvidiofolder"')